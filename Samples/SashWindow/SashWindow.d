...
import wx.wx;
	...
	public class MainPanel : Panel
	{
		...
		public this(Window parent)
		{
			...
			topWindow = new SashLayoutWindow( this, Cmd.ID_WINDOW_TOP, 
				wxDefaultPosition, new_Size( 200, 30 ), 
				wxNO_BORDER | SashWindow.wxSW_3D );
			topWindow.DefaultSize = new_Size( 1000, 30 );
			...
			bottomWindow = new SashLayoutWindow( this, Cmd.ID_WINDOW_BOTTOM, 
				wxDefaultPosition, new_Size( 200, 30 ), 
				wxNO_BORDER | SashWindow.wxSW_3D );
			bottomWindow.DefaultSize = new_Size( 1000, 30 );
			...
			leftWindow1 = new SashLayoutWindow( this, Cmd.ID_WINDOW_LEFT1, 
				wxDefaultPosition, new_Size( 200, 30 ), 
				wxNO_BORDER | SashWindow.wxSW_3D );
			leftWindow1.DefaultSize = new_Size( 120, 1000 );
			...
			leftWindow2 = new SashLayoutWindow( this, Cmd.ID_WINDOW_LEFT2, 
				wxDefaultPosition, new_Size( 200, 30 ), 
				wxNO_BORDER | SashWindow.wxSW_3D );
			leftWindow2.DefaultSize = new_Size( 120, 1000 );
		...
		public void OnSashDraggedRange( Object sender, Event e )
		{
			...
			switch ( eventID )
			{
				case Cmd.ID_WINDOW_TOP:
					topWindow.DefaultSize = new_Size( 1000, se.DragRect.Height );
				break;

				case Cmd.ID_WINDOW_LEFT1:
					leftWindow1.DefaultSize = new_Size( se.DragRect.Width, 1000 );
				break;

				case Cmd.ID_WINDOW_LEFT2:
					leftWindow2.DefaultSize = new_Size( se.DragRect.Width, 1000 );
				break;

				case Cmd.ID_WINDOW_BOTTOM:
					bottomWindow.DefaultSize = new_Size( 1000, se.DragRect.Height );
				break;
			}
	...
	public class SashWindowApp : App
	{
		...
		{
			SashWindowFrame frame = new SashWindowFrame( "SashWindow wxWidgets Sample", new_Point( 10, 100), new_Size(650,340) );
			frame.Show( true );
